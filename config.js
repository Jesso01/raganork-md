...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~7c291cb1bfdd9fe8436df7d5ae803e7b:30726c6b587746697469383d').trim() || '',
    ...
    HEROKU: {
        ...
        API_KEY: process.env.HEROKU_API_KEY || '2ef9fd39-2877-4fa8-ac88-1dc200fb6090',
        APP_NAME: process.env.HEROKU_APP_NAME || 'kinnnnn'
    },
